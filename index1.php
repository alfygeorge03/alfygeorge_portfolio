...
<section id="projects">
  ...
  <div class="subproject">
      ...
      <h3>Student Management System (Laravel)</h3>

      <p>
          Student Management System is a Laravel-based web application designed to manage students, attendance, classes, and school operations efficiently. The system includes student CRUD operations, real-time attendance management with toggle functionality, previous date attendance tracking, class-wise filtering, attendance percentage calculation, PDF report generation, and responsive dashboard UI. It is built using Laravel, MySQL, Tailwind CSS, JavaScript, and AJAX, with future-ready AI integration features for analytics and smart student management.
      ...
      <a href="https://github.com/alfygeorge03/student_management_system"
      class="btn" target="_blank">
          View Project
      </a>
